...
const active_optionActions = require("../pages/active_option/active_optionActions");
...
describe("Automation for Swag Labs",()=>{
    ...
    it("Should able to successfully login and reset app state",async()=>{
        ...
        await active_optionActions.clickOnActive_option();
        await browser.pause(1000);
        await active_optionActions.clickOnZtoA_option();
        await browser.pause(1000);
    ...
    it("Should able to successfully addtocart journey",async()=>{
        ...
        await addToCartActions.clickOnTshirt();
